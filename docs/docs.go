...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/analitik/rekomendasi_tindakan": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Kode Cacat Spesifik (Opsional)",
                        "name": "kode_cacat",
                        "in": "query"
                    }
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/analitik.DTORekomendasiTindakan"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        "analitik.DTODetailRekomendasiTindakan": {
            "type": "object",
            "properties": {
                "alasan": {
                    "type": "string",
                    "example": "Rasio NG melebihi ambang kritis."
                },
                "prioritas": {
                    "type": "string",
                    "example": "TINGGI"
                ...
                "tindakan": {
                    "type": "string",
                    "example": "Lakukan investigasi defect dominan pada line terkait."
                }
            }
        },
        ...
        "analitik.DTOIndikatorRekomendasiTindakan": {
            "type": "object",
            "properties": {
                "defect_dominan": {
                    "type": "string",
                    "example": "LAMINATING BOLONG"
                },
                "rasio_ng": {
                    "type": "number",
                    "example": 5
        ...
        "analitik.DTORekomendasiTindakan": {
            "type": "object",
            "properties": {
                "indikator": {
                    "$ref": "#/definitions/analitik.DTOIndikatorRekomendasiTindakan"
                },
                "rekomendasi": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/analitik.DTODetailRekomendasiTindakan"
                    }
                },
                "ringkasan": {
                    "type": "string",
                    "example": "Rasio NG berada pada level waspada."
                },
                "status": {
                    "type": "string",
                    "example": "WASPADA"
