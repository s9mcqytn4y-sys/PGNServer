    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'relasiPartDefect' => $data['relasiPartDefect']->map(fn (QControlPartJenisDefect $relasiPartDefect) => [
                ...
                'kategoriDefectId' => $relasiPartDefect->jenisDefectTerkait?->kategori_defect_id,
                'kodeKategoriDefect' => $relasiPartDefect->jenisDefectTerkait?->kategoriDefectTerkait?->kode_kategori,
                'namaKategoriDefect' => $relasiPartDefect->jenisDefectTerkait?->kategoriDefectTerkait?->nama_kategori,
