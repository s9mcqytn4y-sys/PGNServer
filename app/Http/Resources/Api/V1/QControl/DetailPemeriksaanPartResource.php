...
final class DetailPemeriksaanPartResource extends JsonResource
{
     ...
     *     materialIdSnapshot: string|null,
     *     namaMaterialSnapshot: string,
     *     kategoriNgSnapshot: string|null,
     *     totalCheck: int,
     *     totalOk: int,
     *     totalDefect: int,
     *     rasioDefect: float,
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'materialIdSnapshot' => $pemeriksaanPart->material_id_snapshot,
            ...
            'kategoriNgSnapshot' => $pemeriksaanPart->kategori_ng_snapshot,
